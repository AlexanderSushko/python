...
class StoreMashines:
    ...
    def reception(self):
        ...
        try:
            ...
            unique = {'Название: ': unit, 'Цена за шт.: ': unit_p, 'Количество: ': unit_q}
...
unit_1 = Printer('Hewlett Packard', 2000, 5, 10)
unit_2 = Scanner('EPSON', 1200, 5, 10)
unit_3 = Copier('KONICA MINOLTA', 1500, 1, 15)
